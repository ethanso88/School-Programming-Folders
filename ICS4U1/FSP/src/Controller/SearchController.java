...
//handles all filter logic and updates the material list
public class SearchController {
    //fields for the search frame and all materials
    private final SearchFrame searchFrame;
    private final List<Material> allMaterials;

    //constructor sets up the search frame and listeners
    ...
    //sets up all the listeners for the filters and search bar
    ...
    //updates the list of materials based on all the filters
