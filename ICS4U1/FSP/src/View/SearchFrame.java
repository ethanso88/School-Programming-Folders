...
//this is the search screen for the nanomaterials database
//lets you filter and search for different materials
public class SearchFrame {
    ...
    private void frameSetup() {
        ...
        String logoPath = "Icons/nmda_logo.png";
        ...
        exitButton.setBackground(new Color(200, 60, 40));
        ...
        resetFiltersButton.setBounds(240, 10, 140, 40);
        ...
        int exitX = frameWidth - 30 - exitW;
        int backX = exitX - buttonGap - backW;
        int helpX = backX - buttonGap - helpW;

        helpButton.setBounds(helpX, y - (helpH - backH) / 2, helpW, helpH);
        ...
        resultsScrollPane.setBounds(420, 160, 900, 540);
    ...
    private void setupFilterPanel() {
        ...
        filterPanel.setBounds(40, 160, 350, 540);
        ...
        for (int j = 0; j < nanotubeRadioLabels.length; j++) {
            ...
            nanotubeRadios[j].setBounds(40, y, 150, 20);
        ...
        String[] nanotubeConfigs = {"Pure", "Filtered", "Functionalized"};
        ...
        String[] quantumDotSolvents = {"Water", "Toluene", "Hexane"};
